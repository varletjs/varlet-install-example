  ...
  <div class="example">
    ...
    <var-form ref="form" :disabled="disabled" :readonly="readonly">
      <var-space direction="column" :size="[20, 0]">
        ...
        <var-checkbox-group :rules="[(v) => v.length > 0 || 'The select cannot be empty']" v-model="formData.like">
        ...
        <var-rate :rules="[(v) => v >= 3 || 'It has to be greater than 2']" v-model="formData.score" />
        ...
        <var-slider :rules="[(v) => v > 10 || 'It has to be greater than 10']" v-model="formData.range" />
        <var-uploader :rules="[(v) => v.length >= 1 || 'Upload at least one picture']" v-model="formData.files" />
      </var-space>
    </var-form>
